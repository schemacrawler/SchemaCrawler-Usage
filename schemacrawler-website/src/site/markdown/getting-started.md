...
[There are multiple ways to download, install and use SchemaCrawler.](downloads.html)
...
If you want to experiment locally, look at the [examples](examples/examples-index.html).
