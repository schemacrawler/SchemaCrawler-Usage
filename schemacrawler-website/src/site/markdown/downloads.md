...
[Pre-packaged SchemaCrawler Docker images](https://hub.docker.com/r/schemacrawler/) are available on Docker Hub. Refer to [schemacrawler/SchemaCrawler-MCP-Server-Usage](https://github.com/schemacrawler/SchemaCrawler-MCP-Server-Usage) for SchemaCrawler AI images. See the [Docker](#docker) section below for installation steps.
...
See [Docker Image](docker-image.html) for full documentation on using SchemaCrawler with Docker.
