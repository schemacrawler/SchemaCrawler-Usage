...
See details on configuring lints on the [lints page](lint.md).


## Extending Metadata With Attributes

See details of how to extend SchemaCrawler metadata with table and column metadata and [implicit associations](implicit-associations.md) with [attributes](attributes.md).


## Data Dictionary Extensions

See details of how to extend SchemaCrawler with [Data Dictionary Extensions](data-dictionary-extensions.md).
