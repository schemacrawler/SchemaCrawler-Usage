...
[grep](faq.md#whats-schemacrawler-grep) functionality. SchemaCrawler has powerful
...
SchemaCrawler can generate [SVG diagrams embedded in HTML output](snapshot-examples/snapshot.svg.md). To generate this
