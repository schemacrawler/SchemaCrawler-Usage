...
[HTML5](lint-report-examples/lint_report.md),
...
SchemaCrawler Lint is [very easily extended](plugins.md) for custom database schema checks.
...
For a hands-on walkthrough, see the [lint example](examples/lint.md).
