...
8. [How to do case-insensitive filtering](#case-insensitive)
...
Also see the [filtering and grep command-line options.](faq.md#commands)
...
Further, see the [details on the command-line options.](faq.md#commands)
...
Use the `--routine-types=PROCEDURE` command-line option. Further, see the [details on the command-line options.](faq.md#commands)

---------

### <a name="excluded-remarks">How to exclude database table and column remarks or comments from the output</a>
Use the `--no-remarks` command-line option. Further, see the [details on the command-line options.](faq.md#commands)

---------

### <a name="case-insensitive">How to do case-insensitive filtering</a>
...
Also see the [sorting command-line options.](faq.md#commands)
...
SchemaCrawler integrates with [Graphviz](https://www.graphviz.org/) to produce graph images. See the diagram example in the [SchemaCrawler examples](https://www.schemacrawler.com/downloads.html#running-examples-locally/) download. For more details, see the [diagram section](diagramming.md).
...
_See the documentation in [Extensions Using the Data Dictionary](data-dictionary-extensions.md) ._
...
See the [SchemaCrawler Plugins](plugins.md) page.

---------

### <a name="configure_linter">How to configure SchemaCrawler linters</a>

See [SchemaCrawler Lint](lint.md) for details.
