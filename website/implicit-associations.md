...
In addition, you can [define your own implicit attributes in an attributes file](attributes.md) 
and have them loaded in and displayed in SchemaCrawler output.

For a hands-on walkthrough, see the [implicit associations example](examples/implicit-associations.md).
