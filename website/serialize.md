...
For a hands-on walkthrough, see the [serialize example](examples/serialize.md).
...
metadata to a file, you can load a serialized metadata using the [`offline`](offline.md)
