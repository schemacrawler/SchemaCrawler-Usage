...
The schema will be exported to a file in the specified format in the current directory. You can use JSON or YAML formats. For details on formats, loading serialized catalogs offline, and format limitations, see [SchemaCrawler Serialization](../serialize.md).
