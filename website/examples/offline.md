...
This produces a compressed serialized snapshot file named "offline.ser". For details on snapshot formats, limitations, and requirements, see [SchemaCrawler Offline Catalog Snapshot](../offline.md).
